...
class ContractEmployee extends Employee {
    ...
    public ContractEmployee(String employeeName,double wagePerHour){
        ...
        this.setEmployeeId("C"+getContractIdCounter());
    }
...
class PermanentEmployee extends Employee{
    ...
    public PermanentEmployee(String employeeName,double basicPay,String[] salaryComponents,Asset[] assets){
        ...
        this.assets=assets;
        setPermenantIdCounter(getPermenantIdCounter()+1);
        this.setEmployeeId("E"+getPermenantIdCounter());
    }
    ...
    public Asset[] getAssetsByDate(String lastDate) throws InvalidAssetsException {
        ...
        for(Asset asset:assets){
            ...
            String[] assetParts=asset.getAssetExpiry().split("-");
            ...
            if(assetYear<expiryYear ||
                    (assetYear==expiryYear && assetMonth<expiryMonth) ||
                    (assetYear==expiryYear && assetMonth==expiryMonth && assetDay<=expiryDay)){
                result.add(asset);
            }
        }
        if(result.isEmpty()) throw new InvalidAssetsException("No assets found for the given criteria!");
...
class Admin {
    ...
    public String[] generateAssetsReport(Employee[] employees,char assetCategory){
        ...
        char lowerCategory = Character.toLowerCase(assetCategory);
                ...
                if (assets != null) {
                    for (Asset asset : assets) {
                        if (asset != null && asset.getAssetId() != null &&
                                Character.toLowerCase(asset.getAssetId().charAt(0)) == lowerCategory) {
