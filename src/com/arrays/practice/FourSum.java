...
public class FourSum {
    public static void main(String[] args) {
        List<List<Integer>> r1=fourSumUsingBruteForce(new int[]{1,0,-1,0,-2,2},0);
        System.out.println(r1);
        List<List<Integer>> r2=fourSumUsingBruteForceWithSet(new int[]{1,0,-1,0,-2,2},0);
        System.out.println(r2);
        List<List<Integer>> r3=fourSumUsingTwoPointers(new int[]{1,0,-1,0,-2,2},0);
    ...
    public static List<List<Integer>> fourSumUsingBruteForceWithSet(int[] arr,int target)
    {
        //Method 2. BruteForce + HashSet --> TC:O(n^4) & SC:O(n^3)
        //Creating a set to store all unique quadruplets.
